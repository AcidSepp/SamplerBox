...
def ActuallyLoad():
    ...
    if os.listdir(SAMPLES_DIR):
        print('%s is not empty. Using %s as samples directory.' % (SAMPLES_DIR, os.getcwd()))
        samplesdir = SAMPLES_DIR
    else:
        print('%s is empty. Using %s as samples directory.' % (SAMPLES_DIR, os.getcwd()))
...
try:
    ...
    sd = sounddevice.OutputStream(device=AUDIO_DEVICE_ID, blocksize=512, samplerate=44100, channels=2, dtype='int16',
